            ...
            >
              ...
              >
                <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-slate-900 mb-6 tracking-tight leading-tight">
                  Our Strategic
                  <motion.span 
                    className="block bg-gradient-to-r from-primary-500 via-emerald-700 to-primary-600 bg-clip-text text-transparent mt-2"
                    animate={{ 
                        ...
                        {filteredPartners.map((partner, idx) => (
                          ...
                          >
                            ...
                            >
                              ...
                              {/* Main Card */}
                              <motion.div
                                className="relative h-full p-8 bg-white/50 backdrop-blur-xl rounded-3xl border border-primary-300/40 hover:border-primary-400/60 shadow-medium cursor-pointer overflow-hidden flex flex-col items-center justify-between min-h-[340px] max-h-[340px]"
                                style={{
                              ...
                              >
                                ...
                                >
                                  <h3 className="text-slate-900 font-bold text-xl leading-tight break-words">
                                ...
                                >
                                  ...
                                  />
                                  <span className="relative inline-flex items-center px-6 py-3 bg-white/60 backdrop-blur-sm text-slate-900 text-sm font-semibold rounded-full border border-primary-300/40 transition-all duration-300">
                                    ✨ Strategic Partner
                                  </span>
                                </motion.div>
                                {/* Hover Overlay */}
