          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-max text-base md:text-sm lg:text-base xl:text-lg text-center sm:text-left rounded-2xl overflow-hidden"
              ...
              <thead className="bg-gray-50">
                <tr>
                  <th className="py-3 px-4 font-medium text-gray-700 text-center sm:text-left first:rounded-tl-2xl last:rounded-tr-2xl">ID</th>
              ...
              <tbody className="divide-y divide-blue-100">
                {admins.length === 0 ? (
                  <tr>
                    <td colSpan="4" className="py-8 px-4 text-center sm:text-left text-gray-500">
                  ...
                  admins.map((admin) => (
                    <tr key={admin.id} className="hover:bg-blue-50 transition-colors text-center sm:text-left">
                      <td className="py-4 px-4 font-medium text-gray-900 text-center sm:text-left">{admin.id}</td>
