          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              >
                <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-black mb-6 tracking-tight leading-tight">
                  Our Distinguished
                  <motion.span 
                    className="block bg-gradient-to-r from-gold via-emerald to-gold bg-clip-text text-transparent mt-2"
                    animate={{ 
            ...
            >
              <div className="relative group">
                <motion.div
                  className="absolute -inset-1 bg-gradient-to-r from-emerald via-gold to-emerald rounded-3xl blur opacity-25"
                  animate={{ 
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-8 py-5 bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl text-black placeholder-gray-700 focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold/50 transition-all duration-500 text-lg"
                  />
            ...
            >
              ...
              <div className="relative bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl p-6 sm:p-8 lg:p-12 overflow-hidden">
                ...
                <motion.div
                  className="absolute -inset-1 bg-gradient-to-r from-gold/15 via-emerald/15 to-gold/15 rounded-3xl blur-xl"
                      ...
                      <>
                        {Object.entries(groupedAdvisors).map(([areaOfFocus, advisorsInArea], sectionIdx) => (
                          <div key={areaOfFocus} className="mb-16 last:mb-0">
                            ...
                            >
                              <motion.span
                                className="bg-gradient-to-r from-gold via-emerald to-gold bg-clip-text text-transparent"
                                animate={{ 
                                  backgroundPosition: ["0%", "100%", "0%"],
                                }}
                                transition={{ 
                                      ...
                                      >
                                        ...
                                        >
                                          {!imgErrors[globalIdx] && advisor.photo_url ? (
                                            ...
                                            <motion.div
                                              className="w-24 h-24 bg-gradient-to-br from-emerald via-gold to-emerald rounded-full flex items-center justify-center shadow-2xl relative overflow-hidden"
                                              whileHover={{ boxShadow: "0 0 40px rgba(201, 166, 53, 0.6)" }}
                                            >
                                              <motion.div
                                              ...
                                              />
                                              <span className="text-2xl font-bold text-black select-none relative z-10">
                                        ...
                                        >
                                          <motion.div
                                            className="absolute -inset-1 bg-gradient-to-r from-emerald to-gold rounded-full blur opacity-30"
                                            animate={{ 
                                              opacity: hoveredCard === globalIdx ? 0.6 : 0.3 
                                            }}
                                          />
                                          <span className="relative inline-flex items-center px-6 py-3 bg-white/20 backdrop-blur-sm text-black text-sm font-semibold rounded-full border border-white/30 transition-all duration-300">
                                            ✨ Expert Advisor
                                          </span>
                                        </motion.div>
