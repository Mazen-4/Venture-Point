...
export default function PartnerDetails() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen relative overflow-hidden bg-navy">
        {/* Animated Background */}
        <div className="fixed inset-0 bg-navy/90">
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen">
          ...
          >
            ...
            >
              ...
              />
              <motion.div
                className="absolute inset-4 border-4 border-gold/60 border-l-transparent rounded-full"
                animate={{ rotate: 360 }}
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen">
          ...
          >
            ...
            <motion.button 
              ...
              className="group relative px-10 py-4 bg-gradient-to-r from-emerald to-gold text-white rounded-2xl font-semibold transition-all duration-300 overflow-hidden"
              whileHover={{ 
                scale: 1.05,
            ...
            >
              <motion.div
                className="absolute inset-0 bg-gradient-to-r from-gold to-emerald"
                initial={{ x: "-100%" }}
                whileHover={{ x: "0%" }}
      ...
      <div className="min-h-screen relative overflow-hidden bg-navy">
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen">
          ...
          >
            ...
            <h3 className="text-black text-2xl mb-4 font-semibold">
              Partner Not Found
            </h3>
            ...
            <motion.button
              onClick={() => navigate(-1)}
              className="group relative px-8 py-3 bg-gradient-to-r from-emerald to-gold text-white rounded-xl font-semibold transition-all duration-300"
  ...
  return (
    <div
      className="w-full max-w-8xl rounded-lg sm:rounded-xl md:rounded-2xl shadow-xl p-2 sm:p-4 md:p-8 text-xs sm:text-base overflow-x-auto bg-navy/90 backdrop-blur-xl"
    >
      <div className="min-h-screen relative overflow-hidden">
        ...
        >
          <div className="max-w-6xl mx-auto">
            ...
            <motion.button
              className="group flex items-center gap-2 sm:gap-3 text-gold hover:text-white font-semibold mb-6 sm:mb-12 transition-all duration-300 p-2 sm:p-4 rounded-xl sm:rounded-2xl hover:bg-gold/10 backdrop-blur-sm border border-gold"
              onClick={() => navigate(-1)}
              variants={itemVariants}
              whileHover={{ 
                scale: 1.05,
                x: -5,
                boxShadow: "0 10px 30px rgba(201, 166, 53, 0.2)"
              }}
              whileTap={{ scale: 0.95 }}
            >
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <FaArrowLeft className="text-sm text-black" />
              </motion.div>
            ...
            <motion.div
              variants={itemVariants}
              className="relative bg-navy/80 backdrop-blur-xl rounded-xl sm:rounded-3xl border border-gold shadow-2xl overflow-hidden"
            >
              
              {/* Animated Glow Effect */}
              <motion.div
                className="absolute -inset-1 bg-gradient-to-r from-gold/15 via-emerald/15 to-gold/15 rounded-3xl blur-xl opacity-60"
                variants={glowVariants}
                animate="animate"
              />

              {/* Hero Section */}
              <div className="relative bg-gradient-to-br from-emerald/90 via-gold/90 to-emerald/90 text-white px-4 sm:px-8 py-10 sm:py-20 text-center overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    {partner.image ? (
                      ...
                      >
                        <img
                          src={partner.image}
                          alt={partner.name}
                          className="w-32 h-32 sm:w-48 sm:h-48 object-cover rounded-full border-4 border-gold/40 shadow-2xl"
                          onError={(e) => {
                      ...
                      <motion.div
                        className="relative w-32 h-32 sm:w-48 sm:h-48 bg-emerald rounded-full border-4 border-gold shadow-2xl flex items-center justify-center overflow-hidden"
                        whileHover={{ 
                          scale: 1.1,
                          boxShadow: "0 0 60px rgba(201, 166, 53, 0.6)"
                        }}
                        transition={{ type: "spring", stiffness: 300 }}
                      >
                        <motion.div
                  ...
                  {/* Partner Name */}
                    <h1
                      className="text-2xl sm:text-4xl lg:text-6xl font-bold mb-4 sm:mb-6 drop-shadow-2xl text-gold"
                      initial={{ opacity: 0, y: 50 }}
                      animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <motion.div
                      ...
                      transition={{ duration: 2, repeat: Infinity }}
                    />
                    <div className="relative px-6 sm:px-10 py-2 sm:py-4 bg-white/20 backdrop-blur-sm rounded-full border border-white/30">
                      <span className="text-base sm:text-xl font-semibold text-gold flex items-center gap-2">
                        ✨ Strategic Partner
                      </span>
                    </div>
                  </motion.div>
                ...
                <AnimatePresence>
                  {partner.details ? (
                    ...
                    >
                      ...
                      >
                        <motion.h2 
                          className="text-2xl sm:text-4xl font-bold text-gold mb-4 sm:mb-6"
                      ...
                      >
                        <motion.div
                          className="absolute -inset-4 bg-gradient-to-r from-gold/10 via-emerald/10 to-gold/10 rounded-3xl blur-2xl opacity-0 group-hover:opacity-100"
                          transition={{ duration: 0.5 }}
                        />
                        
                        <div className="relative bg-white/10 backdrop-blur-xl border border-gold/30 rounded-xl sm:rounded-3xl p-4 sm:p-12 shadow-xl">
                          <motion.div
                            className="text-white/90 leading-relaxed text-base sm:text-lg lg:text-xl whitespace-pre-line text-justify"
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                          ...
                          <motion.div
                            className="absolute top-8 left-8 text-6xl text-gold/20 font-serif"
                          ...
                          <motion.div
                            className="absolute bottom-8 right-8 text-6xl text-emerald/20 font-serif transform rotate-180"
                    ...
                    >
                      <motion.div 
                        className="relative p-16 rounded-3xl border border-gold/30 overflow-hidden"
                        style={{
                      ...
                      >
                        ...
                        <motion.div
                          className="absolute inset-0 bg-gradient-to-r from-gold/5 via-emerald/5 to-gold/5"
                          animate={{ 
                        ...
                        <div className="relative z-10">
                          <motion.div 
                            className="w-24 h-24 bg-gradient-to-br from-gold/20 via-emerald/20 to-gold/20 rounded-full flex items-center justify-center mx-auto mb-8 backdrop-blur-sm"
                            animate={{ 
                              scale: [1, 1.1, 1],
                              rotate: [0, 5, -5, 0]
                            }}
