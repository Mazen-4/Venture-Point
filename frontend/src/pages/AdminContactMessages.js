          ...
          <div className="w-full overflow-x-auto">
            ...
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="py-3 px-8 text-left font-medium text-gray-700 min-w-[270px]">Actions</th>
              </tr>
            </thead>
              ...
              {messages.length === 0 ? (
                ...
                messages.map((msg) => (
                  <tr key={msg.id} className={`hover:bg-blue-50 transition-colors ${!msg.read ? 'bg-blue-25' : ''}`}>
                    ...
                    <td className="py-4 px-4 max-w-xs truncate" title={msg.subject}>
                        {msg.subject && msg.subject.length > 20 ? msg.subject.slice(0, 20) + '…' : msg.subject}
                    </td>
                    <td className="py-4 px-4 font-medium text-gray-900 whitespace-nowrap">
                      {new Date(msg.created_at).toLocaleDateString()}
                    </td>
                    <td className="py-4 px-8 min-w-[270px]">
                      <div className="grid grid-cols-2 gap-2 items-stretch justify-center">
                        ...
                        <button
                          ...
                          style={{fontSize: 'clamp(0.95rem, 1vw + 0.8rem, 1.1rem)'}}
                        >
                          <FaEnvelopeOpenText className="text-base" style={{ fontSize: '1.25em' }} /> Mark Unread
                        </button>
                        <button
