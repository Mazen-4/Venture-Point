          ...
          <div className="max-w-7xl mx-auto container">
            <div className="flex flex-col items-center">
              <img
                ...
                alt={member.name}
                className="w-56 h-56 object-cover rounded-full shadow-2xl mb-6 border-4 border-white/20"
              ...
              />
              <h1 className="text-4xl font-poppins font-extrabold text-black mb-2 drop-shadow-lg">
                {member.name}
              </h1>
              <h2 className="text-xl font-poppins text-primary-500 font-semibold mb-4 italic">
                {member.role}
              </h2>
              <div className="text-lg text-black max-w-2xl text-center leading-relaxed mb-8">
              ...
              <div className="max-w-4xl">
                ...
                {member.details ? (
                  <div className="text-black leading-relaxed whitespace-pre-line text-justify">
