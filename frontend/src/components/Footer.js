    ...
    >
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 pb-6 border-b border-gray-700/20">
          <div>
            <h3 className="text-[#3F93E6] font-bold text-lg mb-2 tracking-wide">Contact</h3>
          ...
          <div>
            <h3 className="text-[#3F93E6] font-bold text-lg mb-2 tracking-wide">Address</h3>
            <a
              href="https://www.google.com/maps/place/Street+44,+Al+Abageyah,+El+Mokattam,+Cairo+Governorate/@30.0141044,31.287652,17z"
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm leading-relaxed underline hover:text-[#3F93E6] transition"
            >
              Street 44, El-Nakheel Compound,<br />First settlement, Cairo, Egypt
            </a>
          </div>
          <div>
            <h3 className="text-[#3F93E6] font-bold text-lg mb-2 tracking-wide">Quick Links</h3>
            <ul className="grid grid-cols-2 gap-x-4 gap-y-1 text-sm">
              ...
              <li><a href="/articles" className="hover:text-[#3F93E6] transition">Articles</a></li>
              <li><a href="/contact" className="hover:text-[#3F93E6] transition">Contact</a></li>
            </ul>
          </div>
          <div>
            <h3 className="text-[#3F93E6] font-bold text-lg mb-2 tracking-wide">Follow Us</h3>
            <div className="flex gap-4 mt-2">
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-[#3F93E6] transition"><i className="fab fa-linkedin-in"></i> LinkedIn</a>
            </div>
          </div>
        </div>
        <div className="flex flex-col sm:flex-row justify-between items-center pt-6 text-xs text-gray-50/80">
